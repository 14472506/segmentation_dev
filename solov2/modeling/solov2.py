...
from typing import Dict         # <- This is essential a dict but allows you to specify the data type
from detectron2.layers import ShapeSpec
from detectron2.modeling.proposal_generator.build import PROPOSAL_GENERATOR_REGISTRY

from .solov2_heads import SOLOV2_head
from .solov2_decode import SOLOV2_decode
from solov2.utils import imrescale
from solov2.losses import dice_loss, FocalLoss

__all__ = ['SOLOv2']    # this makes the class public to imports from other files

@PROPOSAL_GENERATOR_REGISTRY.register()    # from detectron2 produces object proposal from feature map https://github.com/facebookresearch/detectron2/blob/main/detectron2/modeling/proposal_generator/build.py 
class SOLOv2(nn.Module):
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        self.head = SOLOV2_head(cfg)        # model imlemented here 
        self.decode = SOLOV2_decode(cfg)    # model decoding goes here
